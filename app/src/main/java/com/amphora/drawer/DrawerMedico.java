...
public class DrawerMedico extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drawer_medico);
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(getApplicationContext(),
                        DetalhesMedicoActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString("nome", nomeMed);
                bundle.putString("crm", crm);
                bundle.putString("pf", pfcrm);
                bundle.putString("uf", ufcrm);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_agenda) {
            startActivity(new Intent(DrawerMedico.this, MainDrawerAg.class));
            finish();

        } else if (id == R.id.nav_medico) {

        } else if (id == R.id.nav_material) {
            startActivity(new Intent(DrawerMedico.this, DrawerMaterial.class));
            finish();

        } else if (id == R.id.nav_import) {
            startActivity(new Intent(DrawerMedico.this, ImportExportActivity.class));
            finish();
        }
